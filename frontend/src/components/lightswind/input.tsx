      ...
      <div className={cn("relative w-full group/input", layoutClasses.join(" "))}>
        <motion.input
          ...
          className={cn(
            ...
            "in-[.lw-3d]:border-black/10 dark:in-[.lw-3d]:border-white/10",
            isFocused 
              ? "border-primary/50 dark:border-primary/30 shadow-[0_0_15px_rgba(var(--primary),0.05)] in-[.lw-3d]:shadow-[inset_0_1.5px_3px_0_rgba(0,0,0,0.15),0_0_0_2px_rgba(23,62,255,0.4)] dark:in-[.lw-3d]:shadow-[inset_0_2px_4px_0_rgba(0,0,0,0.3),0_0_0_2px_rgba(23,62,255,0.4)]" 
              : "in-[.lw-3d]:shadow-[inset_0_1.5px_3px_0_rgba(0,0,0,0.15),0_1px_1px_0_rgba(255,255,255,0.05)] dark:in-[.lw-3d]:shadow-[inset_0_2px_4px_0_rgba(0,0,0,0.3)]",
            otherClasses.join(" ")
          )}
          ref={ref}
          onFocus={(e) => {
