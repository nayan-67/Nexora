                                        ...
                                        <div class="o_px-xs o_sans o_text o_left o_xs-center"
                                            ...
                                            <p style="margin-top: 0px;margin-bottom: 0px;">
                                                <a class="o_text-white" href="https://example.com/"
                                                    ...
                                                    <img src="{{ asset('images/logo_white.png') }}" width="136"
                                                        height="36" alt=""
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="o_btn-xs o_bg-primary o_br o_heading o_text-xs"
                                                            ...
                                                            <a class="o_text-white" href="{{ route('/') }}"
                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="o_sans o_text o_text-secondary o_b-primary o_px o_py o_br-max"
                                                    ...
                                                    <img src="{{ asset('images/shopping_cart-48-primary.png') }}"
                                    ...
                                    <p style="margin-top: 0px;margin-bottom: 0px;">That thus much less heron other
                                        hello</p>
                                </td>
                            </tr>
                        </tbody>
                            ...
                            <tr>
                                <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center"
                                    ...
                                    <h4 class="o_heading o_text-dark o_mb-xs"
                                        ...
                                        Hello,
                                        {{ $billingresult->f_name }}
                                        {{ $billingresult->l_name }}
                                    </h4>
                                    <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;">Thank you for
                                        ordering from AgriExpress. You can track your shipment status using our mobile
                                        tracking. See your order confirmation below.</p>
                                    ...
                                    <div class="o_col o_col-3 o_col-full"
                                        ...
                                        <div class="o_px-xs" style="padding-left: 8px;padding-right: 8px;">
                                            <table width="100%" role="presentation" cellspacing="0"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="o_bg-ultra_light o_br o_px o_py o_sans o_text-xs o_text-secondary"
                                                            align="left"
                                                            style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;background-color: #ebf5fa;color: #424651;border-radius: 4px;padding-left: 16px;padding-right: 16px;padding-top: 16px;padding-bottom: 16px;">
                                                            <p class="o_mb-xs"
                                                            ...
                                                            <p class="o_mb-md"
                                                                ...
                                                                {{ $billingresult->l_name }}
                                                                <br>
                                                                {{ $billingresult->address1 }},<br>
                                                                {{ $billingresult->address2 }}<br>
                                                                {{ $billingresult->city }},
                                                                {{ $billingresult->postcode }}<br>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="o_bg-ultra_light o_br o_px o_py o_sans o_text-xs o_text-secondary"
                                                            ...
                                                            <p class="o_mb-md"
                                                                style="margin-top: 0px;margin-bottom: 24px;">
                                                                {{ $shippingresult->f_name }}
                                                                {{ $shippingresult->l_name }}
                                                                <br>
                                                                {{ $shippingresult->address1 }},<br>
                                                                {{ $shippingresult->address2 }}<br>
                                                                {{ $shippingresult->city }},
                                                                {{ $shippingresult->postcode }}<br>
                                ...
                                <tr>
                                    <td class="o_re o_bg-white o_px o_pt" align="center"
                                                ...
                                                <p style="margin-top: 0px;margin-bottom: 0px;">
                                                    <a class="o_text-primary" href="https://example.com/"
                                                        style="text-decoration: none;outline: none;color: #126de5;"><img
                                                            src="{{ asset('uploads/prd_md_') . $presult->featured_image }}"
                                                            width="184" height="184" alt=""
                                                            style="max-width: 184px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;"></a>
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="o_col o_col-3 o_col-full"
                                            ...
                                            <div class="o_px-xs o_sans o_text o_text-light o_left o_xs-center"
                                                ...
                                                <p class="o_text-xs o_mb-xs"
                                                    style="font-size: 14px;line-height: 21px;margin-top: 0px;margin-bottom: 8px;">
                                        ...
                                        <div class="o_col o_col-1 o_col-full"
                                            ...
                                            <div class="o_hide-xs"
                                                style="font-size: 24px; line-height: 24px; height: 24px;">&nbsp; </div>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="50%" class="o_pt-xs" align="right"
                                                                    ...
                                                                    <p class="o_sans o_text o_text-secondary"
                                                                        style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;color: #424651;">
                                                                        ${{ $ordresult->eco_tax }} USD</p>
                                                                </td>
                                                            </tr>
                                                            @if ($ordresult->discount != '0')
                                                                <tr>
                                                                    <td width="50%" class="o_pt-xs" align="left"
                                                                        style="padding-top: 8px;">
                                                                        <p class="o_sans o_text o_text-secondary"
                                                                            style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;color: #424651;">
                                                                            Discount
                                                                            {{ ($couponresult->type ?? '') == 'PERCENTAGE' ? '(' . $couponresult->amount . '%)' : '' }}
                                                                        </p>
                                                                    </td>
                                                                    <td width="50%" class="o_pt-xs" align="right"
                                                                        style="padding-top: 8px;">
            ...
            <tr>
                <td class="o_bg-light o_px-xs o_pb-lg o_xs-pb-xs" align="center"
                    ...
                    <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0"
                        ...
                        <tbody>
                            <tr>
                                <td class="o_re o_bg-dark o_px o_pb-lg" align="center"
                                    style="font-size: 0;vertical-align: top;background-color: #242b3d;padding-left: 16px;padding-right: 16px;padding-bottom: 32px;">
                                    <!--[if mso]><table cellspacing="0" cellpadding="0" border="0" role="presentation"><tbody><tr><td width="200" align="center" valign="top" style="padding:0px 8px;"><![endif]-->
                                    <div class="o_col o_col-2 o_col-full"
                                        style="display: inline-block;vertical-align: top;width: 100%;max-width: 200px;">
                                        ...
                                        <div class="o_px-xs o_sans o_text-xs o_center"
                                            ...
                                            <p style="margin-top: 0px;margin-bottom: 0px;"><a
                                                    class="o_text-dark_light" href="https://example.com/"
                                                    style="text-decoration: none;outline: none;color: #a0a3ab;"><strong
                                                        style="color: #a0a3ab;">Help Center</strong></a></p>
                                        </div>
                                    </div>
                                            ...
                                            <p style="margin-top: 0px;margin-bottom: 0px;">
                                                <a class="o_text-dark_light" href="https://example.com/"
                                                    style="text-decoration: none;outline: none;color: #a0a3ab;"><img
                                                        src="{{ asset('images/facebook-light.png') }}" width="36"
                                                        height="36" alt="fb"
                                                ...
                                                <a class="o_text-dark_light" href="https://example.com/"
                                                    style="text-decoration: none;outline: none;color: #a0a3ab;"><img
                                                        src="{{ asset('images/twitter-light.png') }}" width="36"
                                                        height="36" alt="tw"
                                                        style="max-width: 36px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;"></a><span>
                                                    &nbsp;</span>
                                                <a class="o_text-dark_light" href="https://example.com/"
                                                    style="text-decoration: none;outline: none;color: #a0a3ab;"><img
                                                        src="{{ asset('images/instagram-light.png') }}"
                                                        width="36" height="36" alt="ig"
                                                        style="max-width: 36px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;"></a><span>
                                                    &nbsp;</span>
                                                <a class="o_text-dark_light" href="https://example.com/"
                                                    style="text-decoration: none;outline: none;color: #a0a3ab;"><img
                                                        src="{{ asset('images/snapchat-light.png') }}" width="36"
                                                        height="36" alt="sc"
                                    ...
                                    <div class="o_col o_col-2 o_col-full"
                                        ...
                                        <div class="o_px-xs o_sans o_text-xs o_center"
                                            ...
                                            <p style="margin-top: 0px;margin-bottom: 0px;"><a
                                                    class="o_text-dark_light" href="https://example.com/"
                                                    style="text-decoration: none;outline: none;color: #a0a3ab;"><strong
                                                        style="color: #a0a3ab;">Preferences</strong></a></p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                </td>
                            ...
                            <tr>
                                <td class="o_bg-dark o_px-md o_pb-lg o_br-b o_sans o_text-xs o_text-dark_light"
                                    align="center"
                                    style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;background-color: #242b3d;color: #a0a3ab;border-radius: 0px 0px 4px 4px;padding-left: 24px;padding-right: 24px;padding-bottom: 32px;">
                                    <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;">
                                        <a class="o_text-dark_light" href="https://example.com/"
                                            style="text-decoration: none;outline: none;color: #a0a3ab;"><img
                                                src="{{ asset('images/badge_appstore-light.png') }}" width="135"
                                                height="56" alt="AppStore"
                                                style="max-width: 135px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;"></a>
                                        <a class="o_text-dark_light" href="https://example.com/"
                                            style="text-decoration: none;outline: none;color: #a0a3ab;"><img
                                                src="{{ asset('images/badge_googleplay-light.png') }}" width="135"
                                                height="56" alt="Google Play"
                                                style="max-width: 135px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;"></a>
                                    </p>
                                    <p class="o_mb-xs" style="margin-top: 0px;margin-bottom: 8px;">©2018 Agri
                                        Express<br>
                                        2603 Woodridge Lane, Memphis, TN 38104, USA
                                    </p>
                                    <p style="margin-top: 0px;margin-bottom: 0px;">
                                        <a class="o_text-xxs o_text-dark_light o_underline"
                                            href="https://example.com/"
                                            style="text-decoration: underline;outline: none;font-size: 12px;line-height: 19px;color: #a0a3ab;">Unsubscribe</a>
                                    </p>
                                </td>
                            </tr>
                        </tbody>
