                    ...
                    <div class="container w-auto border-2 border-top border-primary mx-2 py-2">
                        <div class="page-deatails">
                            <div class="header row fs-7 mt-3">
                                <div class="col-sm-2 text-center fw-bold">Name</div>
                                <div class="col-sm-3 text-center fw-bold">Mail</div>
                                <div class="col-sm-1 text-center fw-bold">Telephone</div>
                                <div class="col-sm-1 text-center fw-bold">Status</div>
                                <div class="col-sm-2 text-center fw-bold">No. of order</div>
                                <div class="col-sm-3 text-center fw-bold">Action</div>
                            </div>
                            <div class="results">
                                @if (count($data) > 0)
                                    @foreach ($data as $row)
                                        ...
                                        <div class='row fs-7'>
                                            <div
                                                ...
                                                {{ $name ?? 'user' }}</div>
                                            <div
                                                class='col-sm-3 text-center d-flex align-items-center justify-content-center'>
                                                {{ $row->email }}</div>
                                            <div
                                            ...
                                            <div class='col-sm-3 text-center d-flex gap-2 justify-content-center'>
                                                ...
                                                <a href='{{ route('user.order', encrypt($row->id)) }}'
                                                    class='btn btn-primary fs-8 px-2 py-0 text-white d-flex align-items-center gap-1'
                                                    style='height: 25px;'><i
